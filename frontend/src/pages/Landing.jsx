    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50 overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            Your personal space to document life's precious moments, thoughts, and feelings.
          </motion.p>
            ...
            {[
              {
                ...
                description: "Write down your daily experiences, feelings, and reflections in a beautiful and organized way."
              },
              {
                icon: <FaCamera className="w-8 h-8" />,
                title: "Attach Memories",
                description: "Add photos, videos, and audio recordings to make your journal entries more vivid and meaningful."
              },
              {
                icon: <FaChartLine className="w-8 h-8" />,
                title: "Track Your Productivity",
                description: "Monitor your daily productivity and mood patterns to better understand yourself."
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
